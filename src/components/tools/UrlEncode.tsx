...
export default function UrlEncode() {
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea value={input} onChange={e => setInput(e.target.value)} placeholder={mode === 'encode' ? 'Enter URL or text...' : 'Enter encoded URL...'} className="w-full h-36 p-4 border border-gray-200 rounded-xl font-mono text-sm outline-none" />
